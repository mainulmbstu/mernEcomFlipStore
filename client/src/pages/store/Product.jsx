...
const Product = () => {
  ...
  let getProducts = async (page = 1, size = 10) => {
    ...
    try {
      ...
      let { data } = await axios.get(
        `${import.meta.env.VITE_BASE_URL}/store/product-list`,
        {
          params: {
            page,
            size,
  ...
  let getSearchAdminProducts = async (page = 1, size = 10, e) => {
    ...
    try {
      ...
      setLoading(true);
      let { data } = await axios.get(
        `${import.meta.env.VITE_BASE_URL}/store/product-search`,
        {
          params: {
            keyword: searchVal,
            page,
  ...
  let getProductsByCat = async (page = 1, size=10, e) => {
    ...
    try {
      setLoading(true);
      let { data } = await Axios.post(`/store/category/${categorySlug}`,
        {
          page,
          size,
